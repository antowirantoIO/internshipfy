    ...
    <div class="col-md-8 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Dialy Activity PKL</h4>
        </div>
        <div class="card-body">
          <form class="form form-vertical" action="{{ route('activity.store') }}" method="POST">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="mb-1">
              ...
              <div class="col-12">
                <div class="mb-1">
                  ...
                  <input type="text" class="form-control" name="divisi" placeholder="Divisi atau Bagian" />
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1">
              ...
              <div class="col-12">
                <div class="mb-1">
                    ...
                    <input type="text" name="date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
                </div>
              </div>
              <div class="col-12">
                <div class="row">
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="text" name="start_time" class="form-control flatpickr-time text-start" placeholder="HH:MM" />
                      </div>
                      <div class="col-md-6 mb-1">
                        <label class="form-label">Sampai Jam <span class="text-danger">*</span></label>
                        <input type="text" name="end_time" class="form-control flatpickr-time text-start" placeholder="HH:MM" />
                      </div>
                  </div>
              </div>
              <div class="col-12">
